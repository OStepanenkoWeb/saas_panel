...
interface IGridOrderImage {
    ProductImage: string
}

export const gridOrderImage:FC<IGridOrderImage> = (props) => (
    <div className=" h-5/6 w-5/6 flex justify-center align-middle">
        <img
...
const renderAvatar =(params: GridRenderCellParams) => {
    ...
    return (
            params.row.ProductImage ?  gridOrderImage(params.row) : <Avatar style={{backgroundColor: params.row.Color}}>
                {params.row.name.toUpperCase().substring(0, 1)}
            </Avatar>

    );
}

interface IGridOrderStatus {
    StatusBg: string
    Status: string
}

export const gridOrderStatus = (props: IGridOrderStatus) => (
    <button
        type="button"
...
interface IGridEmployeeCountry {
    Country: string
}

const gridEmployeeCountry = (props: IGridEmployeeCountry) => (
...
export interface ILineAreaData {
    x: number
    yval: number
}

export const SparklineAreaData:ILineAreaData[] = [
    { x: 1, yval: 2 },
    { x: 2, yval: 6 },
    { x: 3, yval: 8 },
    { x: 4, yval: 5 },
...
export interface IEcomPieChartData {
    x: string,
    y: number,
    text: string
}

export const ecomPieChartData:IEcomPieChartData[] = [
    { x: '2018', y: 18, text: '35%' },
    { x: '2019', y: 18, text: '15%' },
    { x: '2020', y: 18, text: '25%' },
    { x: '2021', y: 18, text: '25%' },
